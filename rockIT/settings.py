...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'ticketStore/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'ticketStore/static_in_env')]
STATIC_ROOT = os.path.join(BASE_DIR, 'static_root')
MEDIA_ROOT = os.path.join(BASE_DIR, 'ticketStore/media_root')
# Auth
...
SITE_ID = 1
LOGIN_REDIRECT_URL = reverse_lazy('core:all-categories')
